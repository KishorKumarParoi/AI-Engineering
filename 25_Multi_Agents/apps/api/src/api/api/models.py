...
class RAGUsedContext(BaseModel):
    ...
    review: str | None = Field(default=None, description="The product review text")
    price: float | str | None = Field(default=None, description="The product price")
    rating_number: int | None = Field(default=None, description="The rating count")
    average_rating: float | None = Field(default=None, description="The average rating")
    ...
    store: str | None = Field(default=None, description="The product store or brand store name")
    brand: str | None = Field(default=None, description="The product brand")
    size: str | None = Field(default=None, description="The product size")
    color: str | None = Field(default=None, description="The product color")
    main_category: str | None = Field(default=None, description="The product main category")
    details: dict | None = Field(default_factory=dict, description="The product details map")
